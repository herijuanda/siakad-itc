;(function (global, factory) {
    ...
    hooks.defineLocale('gom-deva', {
        ...
        calendar: {
            sameDay: '[आयज] LT',
            nextDay: '[फाल्यां] LT',
            nextWeek: '[फुडलो] dddd[, Jam] LT',
            lastDay: '[काल] LT',
            lastWeek: '[फाटलो] dddd[, Jam] LT',
            sameElse: 'L',
        },
        relativeTime: {
            future: '%s',
    ...
    hooks.defineLocale('gom-latn', {
        ...
        calendar: {
            sameDay: '[Aiz] LT',
            nextDay: '[Faleam] LT',
            nextWeek: '[Fuddlo] dddd[, Jam] LT',
            lastDay: '[Kal] LT',
            lastWeek: '[Fattlo] dddd[, Jam] LT',
            sameElse: 'L',
        },
        relativeTime: {
            future: '%s',
    ...
    hooks.defineLocale('id', {
        ...
        longDateFormat: {
            ...
            L: 'DD/MM/YYYY',
            LL: 'D MMMM YYYY',
            LLL: 'D MMMM YYYY[, Jam] HH:mm',
            LLLL: 'dddd, D MMMM YYYY[, Jam] HH:mm',
        },
    ...
    hooks.defineLocale('ne', {
        ...
        calendar: {
            sameDay: '[आज] LT',
            nextDay: '[भोलि] LT',
            nextWeek: '[आउँदो] dddd[, Jam] LT',
            lastDay: '[हिजो] LT',
            lastWeek: '[गएको] dddd[, Jam] LT',
            sameElse: 'L',
        },
        relativeTime: {
            future: '%sमा',
